...
window.CONVERT = {
	...
	uiToSimInput: function(dataUI) {
		...
		let dataInput = {
			...
			resourceNode: dataUI.settings.resourceNode,
			getFuel: dataUI.settings.getFuel,
			getAmmo: dataUI.settings.getAmmo,
			getSteal: dataUI.settings.getSteal,
			getBaux: dataUI.settings.getBaux,
